...
class TicTacToeRandomNPC:
    ...
    def take_random_turn(self, player):
        x_rand = random.randint(0,3)
        y_rand = random.randint(0,3)
        while (self.is_valid_move(x_rand, y_rand) == False):
            x_rand = random.randint(0, 3)
            y_rand = random.randint(0, 3)
        self.place_player(player, x_rand, y_rand)